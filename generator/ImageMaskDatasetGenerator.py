...
if __name__ == "__main__":
  try:
    ...
    output_dir   = "./Augmented-Abdomainal-US/"
    ...
    images_dir   = "./abdominal_US/AUS/images/train/"
    masks_dir    = "./abdominal_US/AUS/annotations/train/"   
    ...
    images_dir   = "./abdominal_US/AUS/images/test/"
    masks_dir    = "./abdominal_US/AUS/annotations/test/"   
    generator.generate(images_dir, 
                        masks_dir,
                        output_images_dir, 
                        output_masks_dir)
